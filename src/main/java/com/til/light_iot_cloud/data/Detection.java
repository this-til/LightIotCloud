...
public class Detection {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getKeyframeId() == null ? other.getKeyframeId() == null : this.getKeyframeId().equals(other.getKeyframeId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getKeyframeId() == null) ? 0 : getKeyframeId().hashCode());
